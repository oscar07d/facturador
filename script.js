...
const translations = {
    es: {
        ...
        // --- Main Headers ---
        appPageTitleCreate: "Crear Nueva Factura",
        appPageTitleView: "Mis Facturas",
        appPageTitleClients: "Clientes",
        appPageTitleProfile: "Mi Cuenta",
        appPageTitleHome: "Dashboard de Productividad",

        // --- Profile Section ---
        profileHeader: "Mi Cuenta",
        profileAccountHeader: "Cuenta",
        profilePhoto: "Foto de perfil",
        profilePhotoDesc: "Editar foto de perfil",
        profileName: "Nombre",
        profileNameDesc: "Editar nombre",
        profilePhone: "Número de teléfono",
        profilePhoneDesc: "Editar número de teléfono",
        profilePreferencesHeader: "Preferencias",
        profileLanguage: "Idioma",
        profileLanguageDesc: "Seleccionar idioma",
        profileTheme: "Tema",
        profileThemeDesc: "Seleccionar tema",
        profilePrivacyHeader: "Privacidad y seguridad",
        profileNotifications: "Notificaciones",
        profileNotificationsDesc: "Gestionar notificaciones",
        profileSecurity: "Seguridad de la cuenta",
        profileSecurityDesc: "Ajustes de seguridad",
        profileHelpHeader: "Ayuda y soporte",
        profileFaq: "Preguntas frecuentes",
        profileFaqDesc: "Preguntas frecuentes",
        profileSupport: "Soporte",
        profileSupportDesc: "Contactar con soporte",
        profileOtherHeader: "Otros",
        profileLogout: "Cerrar Sesión",
        profileLogoutDesc: "Finalizar tu sesión actual",

        // --- Create Invoice Form ---
        emitterSectionLegend: "Datos del Emisor (Tu Comercio)",
        emitterNameLabel: "Nombre del Comercio:",
        emitterIdLabel: "NIT/C.C./Identificación:",
        emitterAddressLabel: "Dirección:",
        emitterPhoneLabel: "Teléfono:",
        emitterEmailLabel: "Correo Electrónico:",
        
        clientSectionLegend: "Datos del Cliente",
        clientSelectLabel: "Seleccionar Cliente:",
        newClientOption: "-- Nuevo Cliente --",
        editClientBtn: "Editar Cliente",
        deleteClientBtn: "Eliminar Cliente",
        updateClientBtn: "Guardar Cambios",
        clientNameLabel: "Nombres y Apellidos:",
        clientPhoneLabel: "Celular:",
        clientEmailLabel: "Correo Electrónico:",

        invoiceDetailsLegend: "Detalles de la Factura",
        invoiceNumberLabel: "Número de Factura:",
        invoiceDateLabel: "Fecha de Factura:",
        serviceStartDateLabel: "Fecha Inicio de Servicio (Pagos Mensuales):",

        invoiceItemsLegend: "Ítems de la Factura",
        invoiceItemsPlaceholder: "Aún no has agregado ítems.",
        addNewItemTitle: "Añadir Nuevo Ítem",
        itemDescriptionLabel: "Descripción (Producto o Servicio):",
        isStreamingLabel: "¿Es Plataforma de Streaming?",
        profileNameLabel: "Nombre del Perfil:",
        profilePinLabel: "PIN del Perfil:",
        itemQuantityLabel: "Cantidad:",
        itemPriceLabel: "Precio Unitario (COP):",
        applyIVALabel: "Aplicar IVA (19%)",
        addItemBtn: "Agregar Ítem",

        totalsSectionLegend: "Totales y Estado de Pago",
        discountTypeLabel: "Tipo de Descuento:",
        noDiscountOption: "Sin descuento",
        percentageDiscountOption: "Porcentaje (%)",
        fixedValueDiscountOption: "Valor Fijo (COP)",
        ...
        statusInProcess: "En Proceso de Pago",
        statusPartial: "Pago Parcial",
        statusDisputed: "Disputado",
        statusCancelled: "Cancelado",
        statusUncollectible: "Incobrable",
        
        summaryBoxTitle: "Resumen de la Factura",
        summarySubtotal: "Subtotal:",
        summaryDiscount: "Descuento Aplicado:",
        summaryTaxableBase: "Base Imponible:",
        summaryIVA: "IVA (19%):",
        summaryTotal: "TOTAL FACTURA:",

        statusInfoTitle: "Información del Estado:",
        suggestedAction: "Acción Sugerida:",

        finalActionsLegend: "Acciones Finales",
        saveInvoiceBtn: "Guardar Venta",
        ...
        addNewClientBtn: "Añadir Nuevo Cliente",
        newClientFormLegend: "Datos del Nuevo Cliente",
        newClientNameLabel: "Nombres y Apellidos:",
        newClientPhoneLabel: "Celular:",
        newClientEmailLabel: "Correo Electrónico (Opcional):",
        saveClientBtn: "Guardar Cliente",

        // --- Home/Dashboard Section ---
        dashboardTitle: "Dashboard de Productividad",
        totalRevenueCard: "Ingresos Totales",
        totalDiscountsCard: "Descuentos Aplicados",
        activeClientsCard: "Clientes Activos",
        inactiveClientsCard: "Clientes Inactivos",
        revenueChartCard: "Ingresos por Mes (Últimos 12 meses)",
        chartFilterViewBy: "Ver por:",
        chartFilterLast12Months: "Últimos 12 Meses",
        chartFilterYear: "Año",
        chartFilterMonth: "Mes Específico",
        chartFilterWeek: "Semana Específica",
        chartFilterDay: "Día Específico",
        chartFilterYearLabel: "Año:",
        chartFilterMonthLabel: "Mes:",
        chartFilterWeekLabel: "Semana:",
        chartFilterDayLabel: "Fecha:",
        topItemsCard: "Ítems Más Vendidos",
        // Month Names
        january: "Enero", feb: "Febrero", mar: "Marzo", apr: "Abril", may: "Mayo", jun: "Junio",
        jul: "Julio", aug: "Agosto", sep: "Septiembre", oct: "Octubre", nov: "Noviembre", dec: "Diciembre",

        // --- Modals ---
        // Invoice Detail Modal
        modalInvoiceDetailTitle: "Detalle de Factura",
        modalLoadingText: "Cargando detalles de la factura...",
        modalWhatsAppBtn: "WhatsApp",
        
        // Template Selection Modal
        templateModalTitle: "Seleccionar Tipo de Imagen",
        templateModalPrompt: "¿Qué tipo de imagen deseas generar/usar?",
        templateModalCheckbox: "Es un recordatorio de pago",
        templateModalCheckboxDesc: "Si marcas esto, se usará la plantilla de recordatorio. Si no, se usará la plantilla optimizada para WhatsApp.",
        templateModalFormatLabel: "Formato de imagen:",

        // Payment Update Modal
        paymentUpdateModalTitle: "Actualizar Pago Recurrente",
        paymentUpdateInvoiceLabel: "Factura:",
        paymentUpdateNextDateLabel: "Establecer Próxima Fecha de Pago/Vencimiento:",
        paymentUpdateNextDateDesc: "Al marcar como \"Pagado\", esta será la nueva fecha de vencimiento para el siguiente ciclo.",
        paymentUpdateCancelSubBtn: "Cancelar Suscripción",
        paymentUpdateConfirmBtn: "Marcar como Pagado",
        
        // Edit Profile Modals
        editPhotoModalTitle: "Editar Foto de Perfil",
        editPhotoPreviewAlt: "Vista previa de la foto de perfil",
        editPhotoSelectBtn: "Seleccionar Imagen",
        editPhotoSaveBtn: "Guardar Foto",
        editNameModalTitle: "Editar Nombre",
        editNameInputLabel: "Nombre de la cuenta:",
        editNameInputPlaceholder: "Tu nombre y apellido",
        editPhoneModalTitle: "Actualizar número de teléfono",
        editPhoneCurrentLabel: "Tu número actual es:",
        editPhoneNone: "(ninguno)",
        editPhoneInputLabel: "Nuevo número de teléfono:",
        editPhoneInputPlaceholder: "Escribe tu nuevo número",
        languageModalTitle: "Seleccionar Idioma",
        languageModalPrompt: "Elige el idioma de tu preferencia para la aplicación.",
        languageModalLabel: "Idioma:",
        
        // --- Export Templates ---
        exportTitle: "FACTURA",
        exportBillTo: "FACTURAR A:",
        exportInvoiceNumber: "Nº Factura:",
        exportEmissionDate: "Fecha Emisión:",
        exportDueDate: "Fecha Vencimiento/Pago:",
        exportDescHeader: "DESCRIPCIÓN",
        exportProfileHeader: "PERFIL",
        exportPinHeader: "PIN",
        exportQtyHeader: "CANT.",
        exportPriceHeader: "P.U.",
        exportSubtotalHeader: "SUBTOTAL ÍTEM",
        exportSubtotal: "Subtotal Factura:",
        exportDiscount: "Descuento Aplicado",
        exportIVA: "IVA (19%):",
        exportTotalToPay: "TOTAL A PAGAR:",
        exportGeneratedFile: "Archivo generado:",
        exportQueryCode: "Código de Consulta:",
        exportThanks: "¡Gracias por confiar en",
        
        // WhatsApp & Reminder Templates
        waInvoiceTitle: "FACTURA",
        waEmitted: "Emitida:",
        waClient: "Cliente:",
        waPhone: "Celular:",
        waEmail: "Correo:",
        waDescHeader: "Desc.",
        waTotalHeader: "Total",
        waDueDate: "Fecha de Pago:",
        waQueryCode: "Código Consulta:",
        reminderTitle: "RECORDATORIO DE PAGO",
        reminderGreeting: "Hola,",
        reminderMessage: "Te escribimos para recordarte amablemente que el pago de tu factura está programado para la siguiente fecha.",
        reminderInvoiceNumber: "Factura Nº:",
        reminderDueDate: "Vence el:",
        reminderAmount: "Monto:",
    ...
    en: {
        ...
        // --- Main Headers ---
        appPageTitleCreate: "Create New Invoice",
        appPageTitleView: "My Invoices",
        appPageTitleClients: "Clients",
        appPageTitleProfile: "My Account",
        appPageTitleHome: "Productivity Dashboard",

        // --- Profile Section ---
        profileHeader: "My Account",
        profileAccountHeader: "Account",
        profilePhoto: "Profile picture",
        profilePhotoDesc: "Edit profile picture",
        profileName: "Name",
        profileNameDesc: "Edit name",
        profilePhone: "Phone number",
        profilePhoneDesc: "Edit phone number",
        profilePreferencesHeader: "Preferences",
        profileLanguage: "Language",
        profileLanguageDesc: "Select language",
        profileTheme: "Theme",
        profileThemeDesc: "Select theme",
        profilePrivacyHeader: "Privacy and security",
        profileNotifications: "Notifications",
        profileNotificationsDesc: "Manage notifications",
        profileSecurity: "Account security",
        profileSecurityDesc: "Security settings",
        profileHelpHeader: "Help and support",
        profileFaq: "FAQ",
        profileFaqDesc: "Frequently asked questions",
        profileSupport: "Support",
        profileSupportDesc: "Contact support",
        profileOtherHeader: "Other",
        profileLogout: "Log Out",
        profileLogoutDesc: "End your current session",

        // --- Create Invoice Form ---
        emitterSectionLegend: "Emitter's Data (Your Business)",
        emitterNameLabel: "Business Name:",
        emitterIdLabel: "ID/Tax ID:",
        emitterAddressLabel: "Address:",
        emitterPhoneLabel: "Phone:",
        emitterEmailLabel: "Email:",
        
        clientSectionLegend: "Client's Data",
        clientSelectLabel: "Select Client:",
        ...
        clientPhoneLabel: "Mobile Phone:",
        clientEmailLabel: "Email:",

        invoiceDetailsLegend: "Invoice Details",
        invoiceNumberLabel: "Invoice Number:",
        invoiceDateLabel: "Invoice Date:",
        serviceStartDateLabel: "Service Start Date (Monthly Payments):",

        invoiceItemsLegend: "Invoice Items",
        invoiceItemsPlaceholder: "You haven't added any items yet.",
        addNewItemTitle: "Add New Item",
        itemDescriptionLabel: "Description (Product or Service):",
        isStreamingLabel: "Is it a Streaming Platform?",
        profileNameLabel: "Profile Name:",
        profilePinLabel: "Profile PIN:",
        itemQuantityLabel: "Quantity:",
        itemPriceLabel: "Unit Price (COP):",
        applyIVALabel: "Apply VAT (19%)",
        addItemBtn: "Add Item",

        totalsSectionLegend: "Totals & Payment Status",
        discountTypeLabel: "Discount Type:",
        noDiscountOption: "No discount",
        percentageDiscountOption: "Percentage (%)",
        fixedValueDiscountOption: "Fixed Value (COP)",
        ...
        summaryBoxTitle: "Invoice Summary",
        summarySubtotal: "Subtotal:",
        summaryDiscount: "Discount Applied:",
        summaryTaxableBase: "Taxable Base:",
        summaryIVA: "VAT (19%):",
        summaryTotal: "INVOICE TOTAL:",

        statusInfoTitle: "Status Information:",
        suggestedAction: "Suggested Action:",

        finalActionsLegend: "Final Actions",
        saveInvoiceBtn: "Save Sale",
        ...
        newClientFormLegend: "New Client's Data",
        newClientNameLabel: "Full Name:",
        newClientPhoneLabel: "Mobile Phone:",
        newClientEmailLabel: "Email (Optional):",
        saveClientBtn: "Save Client",

        // --- Home/Dashboard Section ---
        dashboardTitle: "Productivity Dashboard",
        totalRevenueCard: "Total Revenue",
        totalDiscountsCard: "Discounts Applied",
        activeClientsCard: "Active Clients",
        inactiveClientsCard: "Inactive Clients",
        revenueChartCard: "Revenue by Month (Last 12 months)",
        chartFilterViewBy: "View by:",
        chartFilterLast12Months: "Last 12 Months",
        chartFilterYear: "Year",
        chartFilterMonth: "Specific Month",
        chartFilterWeek: "Specific Week",
        chartFilterDay: "Specific Day",
        chartFilterYearLabel: "Year:",
        chartFilterMonthLabel: "Month:",
        chartFilterWeekLabel: "Week:",
        chartFilterDayLabel: "Date:",
        topItemsCard: "Top Selling Items",
        // Month Names
        january: "January", feb: "February", mar: "March", apr: "April", may: "May", jun: "June",
        jul: "July", aug: "August", sep: "September", oct: "October", nov: "November", dec: "December",

        // --- Modals ---
        // Invoice Detail Modal
        modalInvoiceDetailTitle: "Invoice Detail",
        modalLoadingText: "Loading invoice details...",
        modalWhatsAppBtn: "WhatsApp",

        // Template Selection Modal
        templateModalTitle: "Select Image Type",
        templateModalPrompt: "What type of image do you want to generate/use?",
        templateModalCheckbox: "It's a payment reminder",
        templateModalCheckboxDesc: "If checked, the reminder template will be used. Otherwise, the WhatsApp-optimized template will be used.",
        templateModalFormatLabel: "Image format:",

        // Payment Update Modal
        paymentUpdateModalTitle: "Update Recurring Payment",
        paymentUpdateInvoiceLabel: "Invoice:",
        paymentUpdateNextDateLabel: "Set Next Payment/Due Date:",
        paymentUpdateNextDateDesc: "By marking as \"Paid\", this will become the new due date for the next cycle.",
        paymentUpdateCancelSubBtn: "Cancel Subscription",
        paymentUpdateConfirmBtn: "Mark as Paid",

        // Edit Profile Modals
        editPhotoModalTitle: "Edit Profile Picture",
        editPhotoPreviewAlt: "Profile picture preview",
        editPhotoSelectBtn: "Select Image",
        editPhotoSaveBtn: "Save Photo",
        editNameModalTitle: "Edit Name",
        editNameInputLabel: "Account name:",
        editNameInputPlaceholder: "Your first and last name",
        editPhoneModalTitle: "Update phone number",
        editPhoneCurrentLabel: "Your current number is:",
        editPhoneNone: "(none)",
        editPhoneInputLabel: "New phone number:",
        editPhoneInputPlaceholder: "Enter your new number",
        languageModalTitle: "Select Language",
        languageModalPrompt: "Choose your preferred language for the application.",
        languageModalLabel: "Language:",

        // --- Export Templates ---
        exportTitle: "INVOICE",
        exportBillTo: "BILL TO:",
        exportInvoiceNumber: "Invoice Nº:",
        exportEmissionDate: "Emission Date:",
        exportDueDate: "Due/Payment Date:",
        exportDescHeader: "DESCRIPTION",
        exportProfileHeader: "PROFILE",
        exportPinHeader: "PIN",
        exportQtyHeader: "QTY",
        exportPriceHeader: "UNIT PRICE",
        exportSubtotalHeader: "ITEM SUBTOTAL",
        exportSubtotal: "Invoice Subtotal:",
        exportDiscount: "Discount Applied",
        exportIVA: "VAT (19%):",
        exportTotalToPay: "TOTAL TO PAY:",
        exportGeneratedFile: "File generated:",
        exportQueryCode: "Query Code:",
        exportThanks: "Thank you for trusting",

        // WhatsApp & Reminder Templates
        waInvoiceTitle: "INVOICE",
        waEmitted: "Issued:",
        waClient: "Client:",
        waPhone: "Phone:",
        waEmail: "Email:",
        waDescHeader: "Desc.",
        waTotalHeader: "Total",
        waDueDate: "Payment Date:",
        waQueryCode: "Query Code:",
        reminderTitle: "PAYMENT REMINDER",
        reminderGreeting: "Hello,",
        reminderMessage: "We are writing to kindly remind you that the payment for your invoice is scheduled for the following date.",
        reminderInvoiceNumber: "Invoice Nº:",
        reminderDueDate: "Due on:",
...
async function loadAllNotifications() {
    ...
    // 2. Buscar notificaciones del sistema (novedades)
    ...
    invoicesSnapshot.forEach(docSnap => {
        allNotifications.push({
            ...
            data: docSnap.data(),
            id: docSnap.id,
            date: new Date(docSnap.data().invoiceDate) // Usamos la fecha de la factura para ordenar
        });
    });

    // Procesar notificaciones del sistema con filtro de tiempo
    systemSnapshot.forEach(docSnap => {
        ...
        if (!update.expiresAt || update.expiresAt.toDate() > new Date()) {
            allNotifications.push({
                ...
                data: update,
                id: docSnap.id,
                date: update.createdAt.toDate() // Usamos la fecha de creación para ordenar
            });
        }
    });

    // 3. Ordenar todas las notificaciones juntas por fecha, de más nueva a más vieja
    allNotifications.sort((a, b) => b.date - a.date);

    // 4. Renderizar la lista unificada
    list.innerHTML = '';
        ...
        allNotifications.forEach(notification => {
            ...
            if (notification.type === 'invoice') {
                ...
                item.addEventListener('click', () => {
                    ...
                    setTimeout(() => {
                        const invoiceCard = document.querySelector(`.invoice-list-item[data-invoice-id="${notification.id}"]`);
                        if (invoiceCard) {
                            ...
                            setTimeout(() => {
                                openInvoiceDetailModal(invoice, notification.id);
                            }, 1000);
                        }
                    }, 500);
                });
